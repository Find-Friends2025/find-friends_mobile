...
class _DGButtonState extends State<DGButton> {
  ...
  TextStyle _getTextStyle(BuildContext context) => switch (widget.buttonSize) {
    ButtonSize.larger => DGTypography.headline2Bold.copyWith(
      color: DGColors.static.white,
    ),
    ButtonSize.large => DGTypography.headline2Bold.copyWith(
      color: DGColors.static.white,
    ),
    ButtonSize.medium => DGTypography.headline2Bold.copyWith(
      color: DGColors.static.white,
    ),
    ButtonSize.small => DGTypography.headline2Bold.copyWith(
      color: DGColors.static.white,
    ),
  };
